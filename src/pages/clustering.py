...
def get_data():
      ...
      # Check if data is already loaded in session state
            if 'data' in st.session_state:
                  ...
                  if 'has_labels' in st.session_state and not st.session_state.has_labels:
                        st.error("Δεν υπάρχουν ετικέτες στο αρχείο. Δεν μπορείτε να εκτελέσετε clustering χωρίς ετικέτες.")
                        return None  # Return None to stop further execution
